...
public class Chapter11 extends AbstractDungeon {
    ...
    private void generateSpecialMap() {
        ...
        MapRoomNode node5 = DungeonHelper.createNode(2, 2, new MonsterRoom());
        MapRoomNode node6 = DungeonHelper.createNode(2, 3, new MonsterRoomElite());
        MapRoomNode node7 = DungeonHelper.createNode(3, 3, new RestRoom());
