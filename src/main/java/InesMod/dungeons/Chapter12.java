...
public class Chapter12 extends AbstractDungeon {
    ...
    public Chapter12(AbstractPlayer p, ArrayList<String> theList) {
    ...
    public Chapter12(AbstractPlayer p, SaveFile saveFile) {
    ...
    private void generateSpecialMap() {
        ...
        MapRoomNode node6 = DungeonHelper.createNode(2, 6, new RestRoom());
        MapRoomNode node7 = DungeonHelper.createNode(1, 7, new MonsterRoom());
        MapRoomNode node8 = DungeonHelper.createNode(2, 8, new MonsterRoomElite());
