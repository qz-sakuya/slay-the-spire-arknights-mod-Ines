...
public class Chapter10Scene extends AbstractScene {
    private ArrayList<AbstractGameEffect> circles = new ArrayList<>();

    public Chapter10Scene() {
        super("EyjafjallaResources/img/scenes/siesta.atlas");
    ...
    private void updateParticles() {
        ...
        if (!(AbstractDungeon.getCurrRoom() instanceof com.megacrit.cardcrawl.rooms.TrueVictoryRoom) && this.circles.size() < 72 && !Settings.DISABLE_EFFECTS) {
    ...
    public void renderCombatRoomFg(SpriteBatch sb) {
        if (!this.isCamp) {
            ...
            Iterator<AbstractGameEffect> var2 = this.circles.iterator();
            while (var2.hasNext()) {
