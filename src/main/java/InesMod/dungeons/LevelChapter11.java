 ...
 * 记得注释
 */
public class LevelChapter11 extends AbstractDungeon {
    private static final Logger logger = LogManager.getLogger(LevelChapter11.class.getName());

    public LevelChapter11(AbstractPlayer p, ArrayList<String> theList) {
        super(NAME, "InesMod:Chapter11", p, theList);
        if (scene != null) {
            scene.dispose();
        }
    ...
    public LevelChapter11(AbstractPlayer p, SaveFile saveFile) {
    ...
    private void generateSpecialMap() {
        ...
        MapRoomNode node2 = DungeonHelper.createNode(4, 1, new MonsterRoom());
        MapRoomNode node3 = DungeonHelper.createNode(4, 2, new MonsterRoomElite());
        MapRoomNode node4 = DungeonHelper.createNode(3, 2, new TreasureRoom());
        MapRoomNode node5 = DungeonHelper.createNode(2, 2, new RestRoom());
        MapRoomNode node6 = DungeonHelper.createNode(2, 3, new MonsterRoom());
        MapRoomNode node7 = DungeonHelper.createNode(3, 3, new MonsterRoomElite());
