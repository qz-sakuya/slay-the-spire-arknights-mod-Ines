...
public class TeekazwurtzenLaserEffect extends AbstractGameEffect {
    private float sX;
    private float sY;
    private float dX;
    private float dY;
    ...
    public TeekazwurtzenLaserEffect(float sX, float sY, float dX, float dY) {
        if (img == null) {
        ...
        // --- 修改点 1: 将初始颜色改为暗红色 ---
        // 原代码: this.color = Color.CYAN.cpy();
        this.color = new Color(0.55f, 0.1f, 0.1f, 1.0f);
    ...
    public void render(SpriteBatch sb) {
        ...
        // --- 修改点 2: 将叠加层颜色改为偏红的颜色，保持层次感 ---
        // 原代码: sb.setColor(new Color(0.3F, 0.3F, 1.0F, this.color.a));
        sb.setColor(new Color(0.8f, 0.2f, 0.2f, this.color.a));
